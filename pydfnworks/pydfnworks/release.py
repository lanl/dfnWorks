...
keywords = [
    'Discrete Fracture Networks', 'Subsurface flow and Transport',
...
packages = [
    "pydfnworks", "pydfnworks.general", "pydfnworks.dfnGen",
    ...
    "pydfnworks.dfnGen.meshing.udfm", "pydfnworks.dfnGen.meshing.map_dfn_2_pflotran",
