...
# the line of intersection are removed. Then the mesh is dumped out 
# in binary LaGriT and avs format. 
...
# Create a mesh object named mo_tri
...
# Set imt (integer material type) of all vertices to 1
...
# Write output file, AVS format
assign///maxiter_sm/ 1                                                           
smooth;recon 0
smooth;recon 1
# dump / avs2 / output_{0}.inp / mo_pts

## Read in the lines of intersections
