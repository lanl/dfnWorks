...
def transition_probability_cdf(t_min, t_max, frac_spacing, matrix_porosity, matrix_diffusivity, num_pts):
    '''
...
def transfer_probabilities(b_min,
    ...
    a_min = (matrix_porosity * np.sqrt(params["mdiff"])) / b_max
    ...
    a_max = (matrix_porosity * np.sqrt(params["mdiff"])) / b_min
...
def set_up_limited_matrix_diffusion(G, frac_spacing, matrix_porosity, matrix_diffusivity):
    ...
    b_min, b_max, t_min, t_max  = get_aperture_and_time_limits(G)
