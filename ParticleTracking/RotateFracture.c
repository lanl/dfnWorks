...
/********* function uses rotation matrix and normal vector to rotate fracture  **********/
/*************from  3D domain into positions parallel to xy plane *****************/
void   Convertto2d()
...
{
  /****** Particle moves to different fracture: ********/
  /****** current 2D coordinates converted to 3D and recalculated to*********/ 
  /******* new 2D coordinates in new fracture *******************/    
  int j;
...
/****** function calculates 3d coordinates of current particle's position ************/
struct posit3d CalculatePosition3D()
{
  ...
  if (fracture[j].theta!=0.0)
	...
	if (node[fracture[j].firstnode-1].fracture[1]==particle[np].fracture)
...
///////////////////////////////////////////////////////////////////////////////
/*** function recalculates 2d coordinates of velocities into 3D coord *****/
/**** Not used in particle tracking, good for visualization 
...
{
  /*** function converts particle's 2d velocity vector into 3D c. *********/
