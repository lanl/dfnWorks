...
def test(outputPath):
	...
	test_folder = outputPath + '/Small_Intersection_Tests'
...
#1
	...
	print "\n********* Running Small Intersection Tests: **********"
	print   "******************************************************\n"
	
	for i in range(len(list)):
		 
		test_name = 'Small_Intersection_Test_%d' % i 
		...
		input_filename = test_subFolder + 'input_Small_Intersection_Rects_%0.5f.dat' % list[i]
