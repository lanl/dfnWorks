...
def test(outputPath):
	...
	test_folder = outputPath + '/Angled_Intersection_Shortening_Tests'
	...
	print "\n*** Running Angled Intersection Shortening Tests: ****"
	print   "******************************************************\n"
	...
	for i in range(len(Key)):
		...
		input_filename = test_subFolder + 'input_' + test_name + 'Rects_%d.dat' % i
