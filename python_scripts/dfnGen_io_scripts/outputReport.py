...
How to run:   
    python3 outputReport.py [radii file path] [families file path] [translations file path] [Rejections file path]
...
outputPDF = PdfPages('pdfOutputReport.pdf') ## TODO to make this cmd line option --> outputPDF = PdfPages(sys.argv[5])
...
def collectFamilyInfo():
        radiiFile = open(sys.argv[1], 'r')    ## TODO add cmd line checks for args?  
        famFile = open(sys.argv[2], 'r')
        famObj = polyFam(0, [], 0, "", {})
