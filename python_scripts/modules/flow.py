...
class flow():
    def __init__(self, _inp_file, _mesh_type, _uge_file, _vtk_file, _perm_file, _perm_cell_file, _local_dfnFlow_file, _aper_file, _aper_cell_file, _dfnFlow_file, _ncpu, _jobname):
        self._inp_file = _inp_file
        self._mesh_type = _mesh_type
        self._uge_file = _uge_file
        self._vtk_file = _vtk_file
        self._perm_file = _perm_file
        self._perm_cell_file = _perm_cell_file
        self._local_dfnFlow_file = _local_dfnFlow_file
        self._aper_file = _aper_file
        self._aper_cell_file = _aper_cell_file
        self._dfnFlow_file = _dfnFlow_file
        self._ncpu = _ncpu
        self._jobname = _jobname
