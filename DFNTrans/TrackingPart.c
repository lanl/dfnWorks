              ...
              if (all_out==0)          
               {
                ...
                if ((FLAG_OUT==1)|| (all_out==1)) 
                {
                    ...
                    {
                        if (particle[np].cell!=0)
                        fprintf(fnp,"\n %d  %d  %d  %5.12E  %5.12E  %5.12E   %5.12E ",np+1, particle[np].cell, particle[np].fracture, particle3dposit.cord3[0], particle3dposit.cord3[1],particle3dposit.cord3[2], particle[np].fl_weight);                               else
