...
unsigned int marfa=0, plumec=0, disp_o=0, timecounter=0, frac_o=0, tfile=1;
...
//  if (np==51)
 //   printf("cell %d lambda %lf %lf %lf %lf \n", numc, lambda.weights[0], lambda.weights[1], lambda.weights[2], lambda.weights[0]+lambda.weights[1]+lambda.weights[2]); 
