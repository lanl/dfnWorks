...
Note that fini and init should be excluded because they are not functions
...
#define ex_get_entity_count_per_polyhedra vtk_exodus__ex_get_entity_count_per_polyhedra
#define ex_get_n_conn vtk_exodus__ex_get_n_conn
#define ex_get_n_one_attr vtk_exodus__ex_get_n_one_attr
#define ex_get_n_var vtk_exodus__ex_get_n_var
#define ex_get_name_internal vtk_exodus__ex_get_name_internal
#define ex_get_names_internal vtk_exodus__ex_get_names_internal
#define ex_max_name_length vtk_exodus__ex_max_name_length
#define ex_put_entity_count_per_polyhedra vtk_exodus__ex_put_entity_count_per_polyhedra
#define ex_put_n_nodal_var vtk_exodus__ex_put_n_nodal_var
#define ex_put_n_one_attr vtk_exodus__ex_put_n_one_attr
#define ex_put_n_var vtk_exodus__ex_put_n_var
#define ex_put_name_internal vtk_exodus__ex_put_name_internal
#define ex_put_names_internal vtk_exodus__ex_put_names_internal
#define ex_put_partial_set_dist_fact vtk_exodus__ex_put_partial_set_dist_fact
#define ex_set_max_name_length vtk_exodus__ex_set_max_name_length
#define ex_trim_internal vtk_exodus__ex_trim_internal
#define ex_update_max_name_length vtk_exodus__ex_update_max_name_length
#define safe_free vtk_exodus__safe_free
