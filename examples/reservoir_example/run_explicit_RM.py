...
cmd = os.environ['LAGRIT_EXE'] + ' < /home/astansberry/dfnworks/examples/reservoir_example/CreateWellZone.lgi '
...
cmd = 'python /home/astansberry/dfnworks/examples/reservoir_example/create_boundaries.py'
subprocess.call(cmd,shell=True)
