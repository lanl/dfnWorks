...
void readInParams(FILE *fparams, Params *params) {
    ...
    if(fscanf(fparams, "%s", &params->matID_file) != 1) {
        printf("ERROR reading in material file name\n");
    }
    
    // line 3
    if(fscanf(fparams, "%s", &params->stor_in_file) != 1) {
        printf("ERROR reading in stor_in_file name\n");
    }
    
    // line 4
    if(fscanf(fparams, "%s", &params->stor_out_file) != 1) {
        printf("ERROR reading in stor_out_file name\n");
    }
